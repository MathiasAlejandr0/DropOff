...
export const project: ProjectData = {
  ...
  chartData: {
    ...
    risksByLevel: { critico: 3, alto: 12, medio: 9, bajo: 5 },
    risksByCategory: {
      Técnico: 7,
      Gestión: 6,
      Externo: 6,
  ...
  achievements: [
    ...
    'Plantilla formal de registro y seguimiento de 29 riesgos identificados.',
  ...
  pendingWork: [
    ...
    'Finalizar dashboard (matriz completa de 29 riesgos y planes de mitigación).',
  ...
  risks: [
    ...
    { id: '2.2', name: 'Plazo insuficiente', category: 'Gestión', probability: 'Alta', impact: 'Alto', magnitude: 9, level: riskLevel(9), responsible: 'Juan Pérez', status: 'Activo' },
    ...
    { id: '2.1', name: 'Mala planificación', category: 'Gestión', probability: 'Media', impact: 'Alto', magnitude: 6, level: riskLevel(6), responsible: 'Juan Pérez', status: 'Activo' },
    { id: '2.6', name: 'Cambios en requerimientos', category: 'Gestión', probability: 'Media', impact: 'Alto', magnitude: 6, level: riskLevel(6), responsible: 'Patricia Soto', status: 'Activo' },
    { id: '3.6', name: 'Fallas de conectividad', category: 'Externo', probability: 'Alta', impact: 'Medio', magnitude: 6, level: riskLevel(6), responsible: 'Andrés Muñoz', status: 'Activo' },
    { id: '4.1', name: 'Resistencia de usuarios', category: 'Organizacional', probability: 'Alta', impact: 'Medio', magnitude: 6, level: riskLevel(6), responsible: 'Daniela Herrera', status: 'Activo' },
    { id: '4.2', name: 'Incumplimiento de normas', category: 'Organizacional', probability: 'Alta', impact: 'Medio', magnitude: 6, level: riskLevel(6), responsible: 'Patricia Soto', status: 'Activo' },
    { id: '5.1', name: 'Problemas legales por privacidad', category: 'Seguridad', probability: 'Media', impact: 'Alto', magnitude: 6, level: riskLevel(6), responsible: 'María González', status: 'Activo' },
    { id: '5.3', name: 'Acceso no autorizado', category: 'Seguridad', probability: 'Media', impact: 'Alto', magnitude: 6, level: riskLevel(6), responsible: 'Carlos Rojas', status: 'Activo' },
    { id: '5.4', name: 'Incumplimiento normativo', category: 'Seguridad', probability: 'Media', impact: 'Alto', magnitude: 6, level: riskLevel(6), responsible: 'María González', status: 'Activo' },
    { id: '2.3', name: 'Recursos insuficientes', category: 'Gestión', probability: 'Media', impact: 'Medio', magnitude: 4, level: riskLevel(4), responsible: 'Juan Pérez', status: 'Activo' },
    ...
    { id: '5.2', name: 'Ciberataque', category: 'Seguridad', probability: 'Baja', impact: 'Alto', magnitude: 3, level: riskLevel(3), responsible: 'Carlos Rojas', status: 'Activo' },
  ],
  team: [
